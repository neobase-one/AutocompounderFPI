 ...
 * The yield optimizing strategy itself is implemented in a separate 'StrategyNeo.sol' contract.
 */
contract NeoVaultV7 is ERC20Upgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    /**
     * @dev Sets the initial values of the Vault. It initializes the vault's own 'Neo' token.
